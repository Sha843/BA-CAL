...
class Transformer(nn.Module):
    def __init__(self,embeddings,num_classes,batch_size=64,device = 'cuda',num_encoder = 3,num_head = 4,
                 last_hidden = 512,hidden = 1024,dim_model = 300,dropout = 0.5,
                 embed=300,pad_size = 500,vocab_size=None,emb_size=300):
